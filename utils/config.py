...
# 添加这些新的命令行参数
parser.add_argument('--use_kg', action='store_true', help='使用 knowledge graph')
parser.add_argument('--use_profile', action='store_true', help='使用用户 profile')
parser.add_argument('--use_context', action='store_true', help='使用上下文信息')
