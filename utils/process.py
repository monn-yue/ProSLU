...
from transformers import BertTokenizer, XLNetTokenizer, ElectraTokenizer
...
class Processor(object):
    ...
    def validate(self, model_path, dataset_path):
        ...
        if self.args.gpu:
            ...
            self.dataset = torch.load(dataset_path, map_location=torch.device('cpu'), weights_only=False)
